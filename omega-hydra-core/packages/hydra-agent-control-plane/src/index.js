...
export const AGENT_REGISTRY = Object.freeze({
  ...
  "skill-forge-agent": {
    ...
    role: "knowledge-transformer",
    mission: "Transform approved source material into provenance-aware Hydra Skill artifacts: skills, missions, companion behaviors, and product templates.",
    permissions: ["read_doctrine", "read_source", "extract_framework", "classify_safety", "generate_skill", "generate_missions", "generate_products", "emit_telemetry"],
    denied: ["production_deploy", "publish_without_review", "expose_secrets", "ingest_unapproved_source"],
    outputs: ["hydra_skill", "mission_templates", "companion_behavior", "product_templates", "safety_review", "telemetry_event"]
  }
});
